...
def return_args():
    ...
    parser.add_argument(
        "--data_path",
        default="./data/fluorescence/Pre",
        type=str,
        help="training data path; subfolders: images, labels",
    )
    parser.add_argument(
        "--ssl_data_path",
        default="./data/fluorescence/unlabel",
        type=str,
    ...
    # Model parameters
    parser.add_argument(
        "--model_name", default="deeplab_transformer", help="select mode: unet, unetr, swinunetr"
    )
    ...
    parser.add_argument("--initial_lr", type=float, default=1e-2, help="learning rate")
